...
@Component({
  ...
  templateUrl: './restricted-cannot-ship-ground.component.html',
  styleUrls: ['./restricted-cannot-ship-ground.component.scss'],
})
export class RestrictedCannotShipGroundComponent implements OnInit {

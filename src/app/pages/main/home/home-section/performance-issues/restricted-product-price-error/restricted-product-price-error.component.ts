...
@Component({
  ...
  templateUrl: './restricted-product-price-error.component.html',
  styleUrls: ['./restricted-product-price-error.component.scss'],
})
export class RestrictedProductPriceErrorComponent implements OnInit {
